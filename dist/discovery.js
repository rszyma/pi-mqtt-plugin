...
export function sanitizeUniqueId(id) {
    return id.replace(/[^a-zA-Z0-9]/g, "_");
}
export function buildDevicePayload(config) {
    return {
...
export function buildDiscoveryMessages(config) {
...
export function buildCleanupMessages(config) {
    const nodeId = sanitizeNodeId(config.instance_id);
    const entities = [
